cylinder.m runs the flow field over a grid of size lx by ly (preset as quite course in the file and you probably want to refine). It does maxT timesteps which needs to be >2000.
